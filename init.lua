...
-- Resizing keymaps
vim.keymap.set("n", "<C-w><Up>", ":resize +2<CR>", { silent = true })
vim.keymap.set("n", "<C-w><Down>", ":resize -2<CR>", { silent = true })
vim.keymap.set("n", "<C-w><Left>", ":vertical resize -2<CR>", { silent = true })
vim.keymap.set("n", "<C-w><Right>", ":vertical resize +2<CR>", { silent = true })
...
vim.api.nvim_set_keymap("n", "gD", ":BufferLinePickClose<CR>", { noremap = true, silent = true })
